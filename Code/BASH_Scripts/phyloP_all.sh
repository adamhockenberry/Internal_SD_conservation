...
#    #outfile=../../Results/Order_Enterobacterales_Representative/phyloP/$(basename $i)
#    #outfile=${outfile/mfasta/wig}
#    #echo $outfile
#    #~/workspace/phast-master/bin/phyloP --wig-scores --refidx 0 --method LRT Representative101seqModel.mod $i > $outfile 
#    outfile=../../Results/Order_Enterobacterales_Representative/phyloP_CONACC/$(basename $i)
#    outfile=${outfile/mfasta/wig}
#    echo $outfile
#    ~/workspace/phast-master/bin/phyloP --wig-scores --refidx 0 --method LRT --mode CONACC Representative101seqModel.mod $i > $outfile 
#    #outfile=../../Results/Order_Enterobacterales_Representative/phyloP_GERP/$(basename $i)
#    #outfile=${outfile/mfasta/wig}
#    #echo $outfile
#    #~/workspace/phast-master/bin/phyloP --wig-scores --refidx 0 --method GERP Representative101seqModel.mod $i > $outfile 
#done
